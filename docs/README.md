...
| ref | [The language reference](reference/README.md) | **Generated.** The error index (95 codes), the command reference, the effect and tier matrix, the prelude and the forms — regenerated by `beck doc reference` and gated on every pull request. The design lives above; this is what a program is checked against |
