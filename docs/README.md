...
| 10 | [Decision log](10-decisions.md) | George's decisions D1–D12, all settled — including the Git/local-first analysis, the language-not-framework rationale, and the name: **Beck** |
