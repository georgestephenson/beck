...
**0 of the corpus's 237 definitions**. An application is records, lists and a page; the heap is not
...
| | Compiled | Refused |
|---|---|---|
| [`corpus/`](../compiler/corpus/) — 39 applications | **0** | 237 |
...
is the work that is missing on *both* targets." It still is. **232 of the corpus's 237 refusals are
