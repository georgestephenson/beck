...
**0 of the corpus's 232 definitions**. An application is records, lists and a page; the heap is not
...
| | Compiled | Refused |
|---|---|---|
| [`corpus/`](../compiler/corpus/) — 38 applications | **0** | 232 |
...
is the work that is missing on *both* targets." It still is. **227 of the corpus's 232 refusals are
