...
a name to agree**, and its refusals are the feature: 377 of the corpus's 387 names rename, ten
...
| | |
|---|---|
| names renamed, verified compiling **and** publishing the same interface | **377** |
