...
a name to agree**, and its refusals are the feature: 386 of the corpus's 396 names rename, ten
...
| | |
|---|---|
| names renamed, verified compiling **and** publishing the same interface | **386** |
