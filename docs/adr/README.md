...
| [0026](0026-a-release-publishes-a-checksum-and-not-a-signature.md) | A release publishes a checksum and not a signature — `beck sign`'s subject is an image manifest, and a compiler release is a tarball |
