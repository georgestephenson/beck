...
have held that line without exception. [`46`](../46-standard-library-report.md) §46.8 hit the first
...
is most of what a MAC is for — and the program would be back where §46.8 started, one indirection
further along.
