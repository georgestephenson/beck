...
**Date:** 2026-08-13
**Context:** [`109`](../109-provenance-report.md),
[`104`](../104-the-release-and-the-installer-report.md) §104.6,
[`99`](../99-supply-chain-report.md) §99.5 and §99.7,
[`92`](../92-sbom-report.md) §92.5, [`12`](../12-standards-and-conformance.md) §12.6,
...
the one stated reason to wait — [`92`](../92-sbom-report.md) §92.5's "this repository has no release
pipeline to attach one to" — stopped being true when
[`104`](../104-the-release-and-the-installer-report.md) built the pipeline.
...
([`104`](../104-the-release-and-the-installer-report.md) §104.3) — an installer that skips
...
- **Unchanged.** The image half still signs with `beck sign` over a manifest digest
  ([`99`](../99-supply-chain-report.md) §99.5), and the two do not meet: this record is about the
...
- **What would supersede this.** A signature over `SHA256SUMS` in a form `cosign verify` reads, or a
  ...
  transparency log, and [`99`](../99-supply-chain-report.md) §99.7 still lists them.
