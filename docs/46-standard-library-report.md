...
| `collections.beck` | `Set[T]`, sorting, grouping, deduplication — 27 definitions, and the only three primitives this directory has ever asked for: `list_min`, `list_max` and `list_sum` (§46.16) |
