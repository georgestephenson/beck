...
| Hot ephemeral state (sessions, presence, cursors, rate counters) | **Non-durable folds** — already a language construct (D1): same semantics, no log persistence; quota counters (F3) are exactly this |
