...
| Supply chain (§42.7) | Trusted publishing before the first crate is published; SLSA **v1.2** and CISA's **2026** SBOM elements as the charter's targets | Diverse double-compiling, recorded against self-hosting | SPDX 3.0 / CycloneDX 1.7 tooling maturity (trigger: first signed release) | — |
