...
| **Read model / projection (CQRS)** | views maintained incrementally by the compiler from the change | **native, built** | [`23`](23-incremental-views-report.md), [`23`](23-incremental-views-report.md) |
