...
//! not stop; it does not bound one that is merely slow, and it is not a quota — `docs/93` §93.15
...
/// calling at once serialise, which is what one pipe means and what §93.15 names as the first thing
