...
// repository builds (docs/17 §17.1, §17.2; docs/102 for the editor, the log and the link). What
...
(() => {
  ...
  // is what `textarea.value` counts in and the conversion belongs where the text is (docs/102).
  ...
  const stored = {
    ...
    // *store*, and `docs/102` §102.6 says so rather than leaving it to be found.
