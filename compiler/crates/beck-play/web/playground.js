...
// repository builds (docs/17 §17.1, §17.2; docs/101 for the editor, the log and the link). What
...
(() => {
  ...
  // is what `textarea.value` counts in and the conversion belongs where the text is (docs/101).
  ...
  const stored = {
    ...
    // *store*, and `docs/101` §101.6 says so rather than leaving it to be found.
