...
- **The namespace is flat and it now spans this directory.** A program can import two library files,
  ...
  [`docs/46`](../../docs/46-standard-library-report.md) §46.10 is the record of the two that
  were waiting.
...
Time zones.
[`46`](../../docs/46-standard-library-report.md) §46.14 says which of those are waiting on a
language feature and which are simply unwritten;
[`docs/46`](../../docs/46-standard-library-report.md) §46.14 says the same for what `http.beck` does not do —
no TLS, no redirects, no percent-encoding; and
[`docs/46`](../../docs/46-standard-library-report.md) §46.14 for what the two newest files leave —
...
[`docs/46`](../../docs/46-standard-library-report.md) §46.8 is why.
